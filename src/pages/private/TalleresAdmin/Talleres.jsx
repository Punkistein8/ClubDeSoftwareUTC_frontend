...
const Talleres = (props) => {
  ...
  return (
    <>
      {cargando ? (
        <div className='mt-10 h-20 flex flex-col justify-center items-center' role="status">
          <svg aria-hidden="true" className="mr-2 w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-[#008ae6]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className='mt-5 font-semibold'>Cargando taller...</span>
        </div>
      ) : (
        <div className='animate__animated animate__fadeIn bg-gray-200 w-3/4 rounded-md shadow-xl mt-3'>
          <h1 className='font-bold p-3 text-xl text-center'><span className='text-stone-900 font-light'>{taller.nombreTaller}</span></h1>
          <hr className='border-gray-400' />
          <h1 className='font-semibold text-left p-3'>Responsables: <span className='text-stone-900 font-light'>{taller.responsables}</span></h1>
          <h1 className='font-semibold text-left p-3'>Descripción: <span className='text-stone-900 font-light'>{taller.descripcion}</span></h1>
          <h1 className='font-semibold text-left p-3'>Inscritos: <span className='text-stone-900 font-light'><>{inscritos}</></span></h1>
